...
This section examines both the categorical and quantitative variables that describe the Kickstarter campaigns in our data set. Categorical variables include staff pick status, launch day, launch month, launch year, and category. Our quantative variables are campaign length and goal size.
