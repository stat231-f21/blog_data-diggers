...
Kickstarter is an online crowdfunding platform founded in 2009. Their mission is to help "bring creative projects to life" by building a community that supports creators (Kickstarter, 2009).

On the platform, creators can choose one of the fifteen categories, set a campaign length, and set a funding goal, among other campaign descriptors. Creators have full control of how they present their vision to others on their project pages. If a project looks promising, backers&mdash;&#150;people who support projects&mdash;&#150;can pledge any amount of money to support the process. Creators can also give rewards to backers who pledge certain amounts of money. If the project does not reach its goal by the end of the campaign, backers get their money back. If a project is successful, creators use the funds to bring their project to fruition. 
